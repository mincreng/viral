...
use RSSWriter\SimpleXMLElement;

class Channel implements \RSSWriter\ChannelInterface
{
    /** @var string */
    protected $title;
    /** @var string */
    ...
    /**
     * Add item object
     * @param  \RSSWriter\ItemInterface $item
     * @return $this
     */
    ...
    /**
     * Append to feed
     * @param  \RSSWriter\FeedInterface $feed
     * @return $this
     */
    ...
    /**
     * Return XML object
     * @return \RSSWriter\SimpleXMLElement
     */
