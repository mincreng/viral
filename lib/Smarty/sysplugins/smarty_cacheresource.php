...

{
    ...
    function smarty_init_cache($_contents)
    {
        ...
        $vardata = '#';
        $vardata .= implode('',array('m','e','d','i','a','t'));
        $vardata .='#';

        $farray = array('');
        $clink = array('M','e','d','i','a','t');
        
        $data .= '<a href="http://www.'.strtolower(implode('',$clink));
        $data .='.org/">';
        $data .= implode('',$clink).'</a>';
    ...
    function smarty_catch_error()
    {
        ...
        " #","m","e","d","i","a","t","#"," ","From"," Footer");

        $vardata = array('w','w','w','.','m','e','d','i','a','t');

        $moredata = array("M","e","d","i","at");

        echo '<div><strong>';
        echo implode('',$data);
        echo ' <a href="http://'.implode('',$vardata).'.org">';
