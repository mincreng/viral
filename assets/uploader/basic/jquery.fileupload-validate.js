...
(function (factory) {
    ...
    $.widget('blueimp.fileupload', $.blueimp.fileupload, {
        ...
        options: {
            ...
            acceptFileTypes: site_filetypes,
            // The maximum allowed file size in bytes:
            maxFileSize: site_maxfilesize, // 10 MB
            ...
            messages: {
                maxNumberOfFiles: translator.getStr("upload_maxnumber"),
                acceptFileTypes: translator.getStr("upload_accepttypes"),
                maxFileSize: translator.getStr("upload_maxsize"),
                minFileSize: translator.getStr("upload_minfsize"),
                alreadyAdded: translator.getStr("upload_alreadyadded")
            }
        },
