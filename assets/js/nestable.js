...
;(function($, window, document, undefined)
{
    ...
    var defaults = {
            ...
            emptyClass      : 'dd-empty',
            expandBtnHTML   : '<button class="btn btn-sm btn-link" data-action="expand" type="button"><i class="fa fa-plus"></i></button>',
            collapseBtnHTML : '<button class="btn btn-sm btn-link" data-action="collapse" type="button"><i class="fa fa-minus"></i></button>',
            group           : 0,
            maxDepth        : 5,
            threshold       : 20,
    ...
    Plugin.prototype = {
                ...
                step  = function(level, depth)
                {
                    ...
                    items.each(function()
                    {
                        var li   = $(this),
                            ...
                            // assign form
                             var form_arr ={};
                             li.find('.panel-body:first').find(':input,select').each(function(index){
                                if($(this).is(':checkbox')){
                                    form_arr[$(this).attr("name")] = $(this).prop('checked');
                                }else{
                                    form_arr[$(this).attr("name")] = this.value;
                                }
                             });                            
                            item = form_arr;
                        if (sub.length) {
        ...
        dragMove: function(e)
        {
            ...
            mouse.distX = (is_rtl == true) ? mouse.lastX - mouse.nowX : mouse.nowX - mouse.lastX;
